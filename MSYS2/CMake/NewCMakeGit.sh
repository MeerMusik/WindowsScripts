...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/CMake/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/CMake/*.* ${SYSTEMDRIVE}/Dev/GitRepos/CMake/* ${SYSTEMDRIVE}/Dev/GitRepos/CMake/
fi
