...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/boost/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/boost/*.* ${SYSTEMDRIVE}/Dev/GitRepos/boost/* ${SYSTEMDRIVE}/Dev/GitRepos/boost/
fi
