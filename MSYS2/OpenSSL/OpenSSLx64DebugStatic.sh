...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/Builds/OpenSSLx64DebugStatic/*.* ${SYSTEMDRIVE}/Dev/Builds/OpenSSLx64DebugStatic/* ${SYSTEMDRIVE}/Dev/Builds/OpenSSLx64DebugStatic/
echo DONE!
