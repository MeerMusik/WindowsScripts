...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/botan/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/botan/*.* ${SYSTEMDRIVE}/Dev/GitRepos/botan/* ${SYSTEMDRIVE}/Dev/GitRepos/botan/
fi
