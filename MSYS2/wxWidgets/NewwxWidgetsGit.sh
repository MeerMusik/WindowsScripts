...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/wxWidgets/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/wxWidgets/*.* ${SYSTEMDRIVE}/Dev/GitRepos/wxWidgets/* ${SYSTEMDRIVE}/Dev/GitRepos/wxWidgets/
fi
