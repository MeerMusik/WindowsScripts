...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/ninja/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/ninja/*.* ${SYSTEMDRIVE}/Dev/GitRepos/ninja/* ${SYSTEMDRIVE}/Dev/GitRepos/ninja/
fi
