...
"${SYSTEMDRIVE}/Dev/Binaries/CMakex64/cmake.exe" .. -Thost=x64 -G "Visual Studio 16 2019" -A x86 -DCMAKE_INSTALL_PREFIX="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Debug" -
DLLVM_ENABLE_ZLIB=OFF -DCMAKE_PREFIX_PATH="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Debug" -DCMAKE_BUILD_TYPE=Debug -DLLVM_EXPERIMENTAL_TARGETS_TO_BUILD="AVR" -DLLVM_ENABLE_LIBXML2=OFF -DLLVM_USE_CRT_DEBUG=MTd
msbuild /m INSTALL.vcxproj
# --- BUILD LLD ---
mkdir ${SYSTEMDRIVE}/Dev/Builds/lld-build-debug
cd ${SYSTEMDRIVE}/Dev/Builds/lld-build-debug
"${SYSTEMDRIVE}/Dev/Binaries/CMakex64/cmake.exe" .. -Thost=x64 -G "Visual Studio 16 2019" -A x86 -DCMAKE_INSTALL_PREFIX="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Debug" -DCMAKE_PREFIX_PATH="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Debug" -DCMAKE_BUILD_TYPE=Debug -DLLVM_USE_CRT_DEBUG=MTd
msbuild /m INSTALL.vcxproj
# --- BUILD CLANG ---
...
"${SYSTEMDRIVE}/Dev/Binaries/CMakex64/cmake.exe" .. -Thost=x64 -G "Visual Studio 16 2019" -A x86 -DCMAKE_INSTALL_PREFIX="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Release"-mt -DCMAKE_PREFIX_PATH="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Release"-mt -
...
"${SYSTEMDRIVE}/Dev/Binaries/CMakex64/cmake.exe" .. -Thost=x64 -G "Visual Studio 16 2019" -A x86 -DCMAKE_INSTALL_PREFIX=C:\Users\Andy\llvm+clang+lld-14.0.6-x86_64-windows-msvc-release-mt -DCMAKE_PREFIX_PATH="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Release"-mt -DCMAKE_BUILD_TYPE=Release -DLLVM_USE_CRT_RELEASE=MT
msbuild /m -p:Configuration=Release INSTALL.vcxproj
# --- BUILD CLANG ---
mkdir ${SYSTEMDRIVE}/Dev/Builds/clang-build-release
cd ${SYSTEMDRIVE}/Dev/Builds/clang-build-release
"${SYSTEMDRIVE}/Dev/Binaries/CMakex64/cmake.exe" .. -Thost=x64 -G "Visual Studio 16 2019" -A x86 -DCMAKE_INSTALL_PREFIX="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Release"-mt -DCMAKE_PREFIX_PATH="${SYSTEMDRIVE}/Dev/Binaries/LLVMForZigx86-MSVC-Release"-mt -DCMAKE_BUILD_TYPE=Release -DLLVM_USE_CRT_RELEASE=MT
msbuild /m -p:Configuration=Release INSTALL.vcxproj
