...
3. New Variants of Scripts ("Ports") will be accepted after I was able to test them. But:<br>
...
2. eMail: MailTo Link: [Opens your eMail Program](mailto:gitrepos@oliverniebuhr.de?subject=WindowsScripts-Unsupported-Scripts-Question-About-Contributing)
