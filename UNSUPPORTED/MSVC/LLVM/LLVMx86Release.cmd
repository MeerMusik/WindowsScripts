...
title BUILD LLVM-X86 RELEASE MSVC
:START
...
if not exist %SystemDrive%\Dev\LLVMx86BuildRelease\ ( 
mkdir %SystemDrive%\Dev\LLVMx86BuildRelease\ 
goto :BUILD 
)

if exist %SystemDrive%\Dev\LLVMx86BuildRelease\ ( 
cd %SystemDrive%\Dev\LLVMx86BuildRelease\
goto :CLEANDIRECTORY 
)
...
del *.* /s /f /q
cd %SystemDrive%\
rmdir %SystemDrive%\Dev\LLVMx86BuildRelease\ /s /q
