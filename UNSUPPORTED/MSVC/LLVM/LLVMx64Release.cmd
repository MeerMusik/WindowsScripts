...
title BUILD LLVM-X64 RELEASE MSVC
:START
...
if not exist %SystemDrive%\Dev\LLVMx64BuildRelease\ ( 
mkdir %SystemDrive%\Dev\LLVMx64BuildRelease\ 
goto :BUILD 
)

if exist %SystemDrive%\Dev\LLVMx64BuildRelease\ ( 
cd %SystemDrive%\Dev\LLVMx64BuildRelease\
goto :CLEANDIRECTORY 
)
...
del *.* /s /f /q
cd %SystemDrive%\
rmdir %SystemDrive%\Dev\LLVMx64BuildRelease\ /s /q
