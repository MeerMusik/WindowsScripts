...
:CHECKFORCMAKEDIR
if exist %SystemDrive%\Dev\GitRepos\CMake\ ( 
cd %SystemDrive%\Dev\GitRepos\CMake\
goto :CLEANDIRECTORY 
)

if not exist %SystemDrive%\Dev\GitRepos\CMake\ ( 
...
timeout /t 4 /nobreak
rmdir %SystemDrive%\Dev\GitRepos\CMake\ /s /q
