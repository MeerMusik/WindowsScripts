...
if [ -d ${SYSTEMDRIVE}/Dev/GTK4Src/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GTK4Src/*.* ${SYSTEMDRIVE}/Dev/GTK4Src/* ${SYSTEMDRIVE}/Dev/GTK4Src/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GTK4Src/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gtk/ ${SYSTEMDRIVE}/Dev/GTK4Src/
fi
cd ${SYSTEMDRIVE}/Dev/GTK4Src/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GTK4Src/*.* ${SYSTEMDRIVE}/Dev/GTK4Src/* ${SYSTEMDRIVE}/Dev/GTK4Src/
echo DONE!
exit
