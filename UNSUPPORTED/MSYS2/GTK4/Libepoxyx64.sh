...
if [ -d ${SYSTEMDRIVE}/Dev/LibepoxySrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/LibepoxySrc/*.* ${SYSTEMDRIVE}/Dev/LibepoxySrc/* ${SYSTEMDRIVE}/Dev/LibepoxySrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/LibepoxySrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libepoxy/ ${SYSTEMDRIVE}/Dev/LibepoxySrc/
fi
cd ${SYSTEMDRIVE}/Dev/LibepoxySrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/LibepoxySrc/*.* ${SYSTEMDRIVE}/Dev/LibepoxySrc/* ${SYSTEMDRIVE}/Dev/LibepoxySrc/
echo DONE!
exit
