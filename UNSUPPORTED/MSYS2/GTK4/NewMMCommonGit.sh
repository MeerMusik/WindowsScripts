...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/mm-common/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/mm-common/*.* ${SYSTEMDRIVE}/Dev/GitRepos/mm-common/* ${SYSTEMDRIVE}/Dev/GitRepos/mm-common/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/GNOME/mm-common.git --verbose --progress
echo DONE!
exit
