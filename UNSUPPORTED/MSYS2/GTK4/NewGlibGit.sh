...
#fi
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/glib/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/glib/*.* ${SYSTEMDRIVE}/Dev/GitRepos/glib/* ${SYSTEMDRIVE}/Dev/GitRepos/glib/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://gitlab.gnome.org/GNOME/glib.git --verbose --progress
echo DONE!
exit
