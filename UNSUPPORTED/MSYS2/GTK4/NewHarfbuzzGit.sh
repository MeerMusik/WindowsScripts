...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/harfbuzz/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/harfbuzz/*.* ${SYSTEMDRIVE}/Dev/GitRepos/harfbuzz/* ${SYSTEMDRIVE}/Dev/GitRepos/harfbuzz/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/harfbuzz/harfbuzz.git --verbose --progress
echo DONE!
exit
