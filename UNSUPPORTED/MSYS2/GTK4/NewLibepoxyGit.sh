...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/libepoxy/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libepoxy/*.* ${SYSTEMDRIVE}/Dev/GitRepos/libepoxy/* ${SYSTEMDRIVE}/Dev/GitRepos/libepoxy/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/anholt/libepoxy.git --verbose --progress
echo DONE!
exit
