...
if [ -d ${SYSTEMDRIVE}/Dev/GTKMM4Src/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GTKMM4Src/*.* ${SYSTEMDRIVE}/Dev/GTKMM4Src/* ${SYSTEMDRIVE}/Dev/GTKMM4Src/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GTKMM4Src/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gtkmm/ ${SYSTEMDRIVE}/Dev/GTKMM4Src/
fi
cd ${SYSTEMDRIVE}/Dev/GTKMM4Src/
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GTKMM4Src/*.* ${SYSTEMDRIVE}/Dev/GTKMM4Src/* ${SYSTEMDRIVE}/Dev/GTKMM4Src/
echo DONE!
exit
