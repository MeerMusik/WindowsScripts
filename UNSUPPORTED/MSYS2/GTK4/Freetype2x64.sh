...
if [ -d ${SYSTEMDRIVE}/Dev/Freetype2Src/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/Freetype2Src/*.* ${SYSTEMDRIVE}/Dev/Freetype2Src/* ${SYSTEMDRIVE}/Dev/Freetype2Src/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/Freetype2Src/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/freetype/ ${SYSTEMDRIVE}/Dev/Freetype2Src/
fi
cd ${SYSTEMDRIVE}/Dev/Freetype2Src/
./autogen.sh
...
#sleep 8s
#rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/Freetype2Src/*.* ${SYSTEMDRIVE}/Dev/Freetype2Src/* ${SYSTEMDRIVE}/Dev/Freetype2Src/
#echo DONE!
exit
