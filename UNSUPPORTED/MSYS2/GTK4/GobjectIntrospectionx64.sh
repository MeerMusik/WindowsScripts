...
if [ -d ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/*.* ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/* ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gobject-introspection/ ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/*.* ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/* ${SYSTEMDRIVE}/Dev/GobjectintrospectionSrc/
echo DONE!
exit
