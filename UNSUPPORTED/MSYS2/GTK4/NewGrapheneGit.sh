...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/graphene/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/graphene/*.* ${SYSTEMDRIVE}/Dev/GitRepos/graphene/* ${SYSTEMDRIVE}/Dev/GitRepos/graphene/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/ebassi/graphene.git --verbose --progress
echo DONE!
exit
