...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/fontconfig/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/fontconfig/*.* ${SYSTEMDRIVE}/Dev/GitRepos/fontconfig/* ${SYSTEMDRIVE}/Dev/GitRepos/fontconfig/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://gitlab.freedesktop.org/fontconfig/fontconfig.git --verbose --progress
echo DONE!
exit
