...
if [ -d ${SYSTEMDRIVE}/Dev/GrapheneSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GrapheneSrc/*.* ${SYSTEMDRIVE}/Dev/GrapheneSrc/* ${SYSTEMDRIVE}/Dev/GrapheneSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GrapheneSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/graphene/ ${SYSTEMDRIVE}/Dev/GrapheneSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GrapheneSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GrapheneSrc/*.* ${SYSTEMDRIVE}/Dev/GrapheneSrc/* ${SYSTEMDRIVE}/Dev/GrapheneSrc/
echo DONE!
exit
