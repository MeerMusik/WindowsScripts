...
if [ -d ${SYSTEMDRIVE}/Dev/GlibmmSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GlibmmSrc/*.* ${SYSTEMDRIVE}/Dev/GlibmmSrc/* ${SYSTEMDRIVE}/Dev/GlibmmSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GlibmmSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/glibmm/ ${SYSTEMDRIVE}/Dev/GlibmmSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GlibmmSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GlibmmSrc/*.* ${SYSTEMDRIVE}/Dev/GlibmmSrc/* ${SYSTEMDRIVE}/Dev/GlibmmSrc/
echo DONE!
exit
