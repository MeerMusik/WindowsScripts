...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/libiconv/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libiconv/*.* ${SYSTEMDRIVE}/Dev/GitRepos/libiconv/* ${SYSTEMDRIVE}/Dev/GitRepos/libiconv/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://git.savannah.gnu.org/git/libiconv.git --verbose --progress
cd ${SYSTEMDRIVE}/Dev/GitRepos/libiconv/
./gitsub.sh pull
echo DONE!
exit
