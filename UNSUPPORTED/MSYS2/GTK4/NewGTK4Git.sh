...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/gtk/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gtk/*.* ${SYSTEMDRIVE}/Dev/GitRepos/gtk/* ${SYSTEMDRIVE}/Dev/GitRepos/gtk/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://gitlab.gnome.org/GNOME/gtk.git --verbose --progress
echo DONE!
exit
