...
export CDFLAGS='-DZLIB_DEBUG -g3 -ggdb -std=c2x -ffunction-sections -fdata-sections -fPIC -fno-lto -Wl,-fno-lto -pipe -O0 -Wall -Wl,-pic -Wl,--gc-sections -Wl,-O0'
...
make --jobs=1 V=1 install prefix='${SYSTEMDRIVE}/Dev/Sources/GTK4/zlib/x86/debug/' BINARY_PATH='${prefix}bin/' INCLUDE_PATH='${prefix}include/' LIBRARY_PATH='${prefix}lib/' -fwin32/Makefile.gcc SHARED_MODE=1
make --jobs=1 distclean
make --jobs=$(nproc) V=1 -fwin32/Makefile.gcc CFLAGS:='$(CRFLAGS)'
make --jobs=1 V=1 install prefix='${SYSTEMDRIVE}/Dev/Sources/GTK4/zlib/x86/release/' BINARY_PATH='${prefix}bin/' INCLUDE_PATH='${prefix}include/' LIBRARY_PATH='${prefix}lib/' -fwin32/Makefile.gcc SHARED_MODE=1
cd ${TMP}
