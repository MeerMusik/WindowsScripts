...
if [ -d ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/*.* ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/* ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libxkbcommon/ ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/
fi
cd ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/*.* ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/* ${SYSTEMDRIVE}/Dev/LibxkbcommonSrc/
echo DONE!
exit
