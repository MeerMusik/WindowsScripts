...
if [ -d ${SYSTEMDRIVE}/Dev/GlibSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GlibSrc/*.* ${SYSTEMDRIVE}/Dev/GlibSrc/* ${SYSTEMDRIVE}/Dev/GlibSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GlibSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/glib/ ${SYSTEMDRIVE}/Dev/GlibSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GlibSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GlibSrc/*.* ${SYSTEMDRIVE}/Dev/GlibSrc/* ${SYSTEMDRIVE}/Dev/GlibSrc/
echo DONE!
exit
