...
if [ -d ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/*.* ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/* ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/harfbuzz/ ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/
fi
cd ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/*.* ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/* ${SYSTEMDRIVE}/Dev/HarfbuzzSrc/
echo DONE!
exit
