...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/pango/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/pango/*.* ${SYSTEMDRIVE}/Dev/GitRepos/pango/* ${SYSTEMDRIVE}/Dev/GitRepos/pango/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://gitlab.gnome.org/GNOME/pango.git/ --verbose --progress
echo DONE!
exit
