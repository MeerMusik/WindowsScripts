...
if [ -d ${SYSTEMDRIVE}/Dev/GettextSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GettextSrc/*.* ${SYSTEMDRIVE}/Dev/GettextSrc/* ${SYSTEMDRIVE}/Dev/GettextSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GettextSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gettext/ ${SYSTEMDRIVE}/Dev/GettextSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GettextSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GettextSrc/*.* ${SYSTEMDRIVE}/Dev/GettextSrc/* ${SYSTEMDRIVE}/Dev/GettextSrc/
echo DONE!
exit
