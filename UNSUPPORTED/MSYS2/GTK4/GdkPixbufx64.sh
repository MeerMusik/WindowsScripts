...
if [ -d ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/*.* ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/* ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gdk-pixbuf/ ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/
fi
cd ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/*.* ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/* ${SYSTEMDRIVE}/Dev/GdkPixbufSrc/
echo DONE!
exit
