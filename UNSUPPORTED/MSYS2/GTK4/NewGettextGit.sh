...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/gettext/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gettext/*.* ${SYSTEMDRIVE}/Dev/GitRepos/gettext/* ${SYSTEMDRIVE}/Dev/GitRepos/gettext/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://git.savannah.gnu.org/git/gettext.git --verbose --progress
echo DONE!
exit
