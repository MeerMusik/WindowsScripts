...
if [ -d ${SYSTEMDRIVE}/Dev/FontconfigSrc/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/FontconfigSrc/*.* ${SYSTEMDRIVE}/Dev/FontconfigSrc/* ${SYSTEMDRIVE}/Dev/FontconfigSrc/
fi
if [ ! -d ${SYSTEMDRIVE}/Dev/FontconfigSrc/ ]; then cp --force --recursive --verbose ${SYSTEMDRIVE}/Dev/GitRepos/fontconfig/ ${SYSTEMDRIVE}/Dev/FontconfigSrc/
fi
cd ${SYSTEMDRIVE}/Dev/FontconfigSrc/
./autogen.sh
...
sleep 8s
rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/FontconfigSrc/*.* ${SYSTEMDRIVE}/Dev/FontconfigSrc/* ${SYSTEMDRIVE}/Dev/FontconfigSrc/
echo DONE!
exit
