...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/zlib/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/zlib/*.* ${SYSTEMDRIVE}/Dev/GitRepos/zlib/* ${SYSTEMDRIVE}/Dev/GitRepos/zlib/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/madler/zlib.git --verbose --progress
echo DONE!
exit
