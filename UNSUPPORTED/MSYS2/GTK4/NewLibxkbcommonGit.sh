...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/libxkbcommon/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libxkbcommon/*.* ${SYSTEMDRIVE}/Dev/GitRepos/libxkbcommon/* ${SYSTEMDRIVE}/Dev/GitRepos/libxkbcommon/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/xkbcommon/libxkbcommon.git --verbose --progress
echo DONE!
exit
