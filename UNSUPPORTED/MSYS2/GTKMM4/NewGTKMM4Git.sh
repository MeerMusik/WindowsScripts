...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/gtkmm/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/gtkmm/*.* ${SYSTEMDRIVE}/Dev/GitRepos/gtkmm/* ${SYSTEMDRIVE}/Dev/GitRepos/gtkmm/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://gitlab.gnome.org/GNOME/gtkmm.git --verbose --progress
echo DONE!
exit
