...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/libsigcplusplus/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/libsigcplusplus/*.* ${SYSTEMDRIVE}/Dev/GitRepos/libsigcplusplus/* ${SYSTEMDRIVE}/Dev/GitRepos/libsigcplusplus/
fi
cd ${SYSTEMDRIVE}/Dev/GitRepos/
git clone https://github.com/libsigcplusplus/libsigcplusplus.git --verbose --progress
echo DONE!
exit
