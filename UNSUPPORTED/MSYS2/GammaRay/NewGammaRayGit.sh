...
if [ -d ${SYSTEMDRIVE}/Dev/GitRepos/GammaRay/ ]; then rm --interactive=never --dir --recursive --force --verbose ${SYSTEMDRIVE}/Dev/GitRepos/GammaRay/*.* ${SYSTEMDRIVE}/Dev/GitRepos/GammaRay/* ${SYSTEMDRIVE}/Dev/GitRepos/GammaRay/
fi
